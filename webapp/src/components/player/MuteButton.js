const MuteButton = ({userState, onClick}) => {
  return (
    <button className="btn rounded-pill" aria-label="Device" data-testid="control-button-skip-forward" title="Mute" onClick={onClick}>
